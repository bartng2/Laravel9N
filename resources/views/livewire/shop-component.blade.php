                                    ...
                                    <div class="paginatoin-area">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6">
                                                <p>Đang hiển thị {{ $products->firstItem() }}-{{ $products->lastItem() }} trong số {{ $products->total() }} mục</p>
                                            </div>
                                            <div class="col-lg-6 col-md-6">
                                                <ul class="pagination-box">
                                                    <li><a href="{{ $products->previousPageUrl() }}" class="Previous"><i class="fa fa-chevron-left"></i> Quay lại</a></li>
