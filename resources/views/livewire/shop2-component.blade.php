                    ...
                    <div class="shop-top-bar mt-30">
                                <div class="shop-bar-inner">
                                    ...
                                    <div class="toolbar-amount">
                                        <span>Hiển thị 1 đến 9 của {{$products->total()}} sản phẩm</span>
                                    </div>
                                </div>
                                       ...
                                       <ul>
                                           <li class="dropdown-holder"><a>Sắp xếp</a>
                                               <ul class="hb-dropdown">
                                                   ...
                                                   <li><a class="{{$orderBy == 'Price: High to Low' ? 'active' : ''}}" href="#" wire:click.prevent="changeOrderBy('Price: High to Low')">Giá từ cao đến thấp</a>
                                                   </li>
                                    ...
                                    <div class="paginatoin-area">
                                        <div class="row">
                                            <div class="col-lg-6 col-md-6">
                                                <p>Hiển thị {{ $products->firstItem() }}-{{ $products->lastItem() }} của {{ $products->total() }} sản phẩm</p>
                                            </div>
                                            <div class="col-lg-6 col-md-6">
                                                <ul class="pagination-box">
                                                    <li><a href="{{ $products->previousPageUrl() }}" class="Previous"><i class="fa fa-chevron-left"></i> Trở lại</a></li>
